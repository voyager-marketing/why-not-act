...
import {Mail, Handshake, Heart, Share2, Users, ArrowRight, Check, FileDown} from 'lucide-react'
...
const involvementOptions = [
  ...
  },
  {
    ...
    description: 'Download our form letter and send it to your elected officials.',
    cta: 'Download Letter',
    href: '/Form letter to present elected officials.docx',
    download: true,
  },
  {
    icon: Heart,
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-grow">
              ...
              <p className="text-gray-400 mb-4">
                ...
                <a href="mailto:info@whynotact.org" className="text-brand-400 hover:text-brand-300 underline">
                  info@whynotact.org
                </a>{' '}
              ...
              >
                ...
                {option.href ? (
                  <a
                    ...
                    className="text-brand-400 hover:text-brand-300 font-bold uppercase tracking-wide text-sm inline-flex items-center"
                  >
                    {option.cta}
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  ...
                  const text = 'Discover a new approach to immigration reform at WhyNotAct.org'
                  window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(url)}`, '_blank', 'noopener,noreferrer')
                }}
                className="w-12 h-12 bg-white/20 hover:bg-white/30 flex items-center justify-center transition-colors cursor-pointer"
              >
              ...
              <button
                onClick={() => {
                  const url = window.location.href
                  const title = 'WhyNotAct - A New Approach to Immigration'
