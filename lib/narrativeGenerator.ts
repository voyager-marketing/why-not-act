...
const NARRATIVE_TEMPLATES = {
  skeptic: {
    ...
    'mid-left': "Thanks for exploring the nuances of immigration policy with us. You've encountered data showing {keyInsight}, and while you may still be weighing the evidence, your engagement shows you care about finding {value1} solutions. We believe that when armed with facts, people like you can make a real difference.",
    'mid-right': "You've taken time to review important data about immigration's impact. The information you've seen regarding {keyInsight} presents real questions about {concern1} and {value1}. We appreciate your careful consideration of this complex issue - thoughtful analysis is the foundation of sound policy.",
  ...
  curious: {
    ...
    'mid-left': "You're clearly someone who values {value1} and {value2}, and your exploration of immigration data reflects that. Through {layerCount} layers of questions, you've learned that {keyInsight}. This kind of evidence-based understanding is exactly what we need more of. The path forward starts with people like you who are willing to engage with the facts.",
    'mid-right': "Your thoughtful engagement with {layerCount} layers of immigration data shows a commitment to understanding the real impacts. You've discovered that {keyInsight}, which has important implications for {concern1} and {value1}. This balanced perspective - grounded in facts rather than rhetoric - is crucial for finding solutions that work.",
